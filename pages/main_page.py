...
class MainPage(BasePage):
    ...
    def click_account_button(self):
        self.wait_and_find_element(MainPageLocators.ACCOUNT_BUTTON)
        account_button = self.wait_clickable_element(MainPageLocators.ACCOUNT_BUTTON)
        account_button.click()

    @allure.step('Нажатие на "Личный Кабинет"')
    def click_lk_in_the_header(self):
        self.wait_and_find_element(MainPageLocators.LK_IN_THE_HEADER)
        lk = self.wait_clickable_element(MainPageLocators.LK_IN_THE_HEADER)
        lk.click()

    @allure.step('Нажатие на кнопку "Восстановить пароль"')
    def click_password_recovery_button(self):
        self.wait_and_find_element(MainPageLocators.PASSWORD_RECOVERY_BUTTON)
        password_recovery_button = self.wait_clickable_element(MainPageLocators.PASSWORD_RECOVERY_BUTTON)
    ...
    def click_login_button(self):
        self.wait_and_find_element(MainPageLocators.LOGIN_BUTTON)
        login_button = self.wait_clickable_element(MainPageLocators.LOGIN_BUTTON)
        login_button.click()
    ...
    def click_constructor(self):
        ...
        constructor = self.wait_clickable_element(MainPageLocators.CONSTRUCTOR)
        constructor.click()
    ...
    def click_order_feed(self):
        self.wait_and_find_element(MainPageLocators.ORDER_FEED)
        order_feed = self.wait_clickable_element(MainPageLocators.ORDER_FEED)
        order_feed.click()
    ...
    def click_bread_element(self):
        self.wait_and_find_element(MainPageLocators.ELEMENT_BREAD)
        element_bread = self.wait_clickable_element(MainPageLocators.ELEMENT_BREAD)
        element_bread.click()
    ...
    def click_close_button_modal_window_details(self):
        self.wait_and_find_element(MainPageLocators.CLOSE_WINDOW_DETAILS)
        close_button = self.wait_clickable_element(MainPageLocators.CLOSE_WINDOW_DETAILS)
        close_button.click()
    ...
    def click_section_sauces_and_add_sauce_to_order(self, driver):
        self.wait_and_find_element(MainPageLocators.SECTION_SAUCES)
        section_sauces = self.wait_clickable_element(MainPageLocators.SECTION_SAUCES)
    ...
    def click_set_order_button(self):
        self.wait_and_find_element(MainPageLocators.SET_ORDER_BUTTON)
        order_button = self.wait_clickable_element(MainPageLocators.SET_ORDER_BUTTON)
        order_button.click()
    ...
    def click_close_button_modal_window_id_order(self):
        self.wait_and_find_element(MainPageLocators.MODAL_WINDOW_ID_ORDER_CLOSE)
        close_button = self.wait_clickable_element(MainPageLocators.MODAL_WINDOW_ID_ORDER_CLOSE)
        close_button.click()
